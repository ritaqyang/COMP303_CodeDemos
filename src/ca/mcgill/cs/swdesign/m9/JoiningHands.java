...
public class JoiningHands
{
	public static void main(String[] args)
	{
		...
		t1.start();
		t2.start();
//		t1.interrupt(); // Uncomment this line only and t2 will synchronize on t1's abnormally quick termination
//		t2.interrupt(); // Uncomment this line only and t2 will be interrupted, but t1 will remain oblivious and terminate normally
